...
| [agentcore-payments](./examples/agentcore-payments) | A payment-enabled LangChain agent with local Coinbase testnet onboarding, automatic x402 handling, infrastructure-enforced budgets, and AWS-region LangSmith tracing | LangChain + LangGraph + langchain-aws + Bedrock + AgentCore Payments + LangSmith |
